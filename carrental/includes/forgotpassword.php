...
if(isset($_POST['update']))
{
  ...
  $sql ="SELECT EmailId FROM wowusers WHERE EmailId=:email and ContactNo=:mobile";
  ...
  if($query -> rowCount() > 0)
  {
    $con="update wowusers set Password=:newpassword where EmailId=:email and ContactNo=:mobile";
